...
hifive hic-data -X data/WT_100kb/raw_\*.mat genome_partition.txt data_file.txt
...
bedtools intersect -a data/WT_fpkm.bed -b positive_hic_comp.bed -f 0.5 -wa > pos_overlap
bedtools intersect -a data/WT_fpkm.bed -b negative_hic_comp.bed -f 0.5 -wa > neg_overlap